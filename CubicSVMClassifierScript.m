...
%% Load model
load CubicSVMClassifier.mat

rng(32);
%% Train classifier

Model = CubicSVMClassifier.ClassificationSVM;
...
title('ROC for Classification by SVM, Training Data Set')
...
xlabel('False positive rate') 
ylabel('True positive rate')
title('ROC for Classification by SVM, Test Data Set')
